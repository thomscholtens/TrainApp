...
class RouteAdapter(private val routes: List<Route>, private val onClick: (Route) -> Unit, private val onSwapClick: (Route) -> Unit)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(route: Route) {
            ...
            itemView.btnEdit.setOnClickListener { onSwapClick(routes[adapterPosition])}
